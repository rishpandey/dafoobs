...
public class Subject {
	...
	public Subject(String subject1, String subject2, String subject3, String subject4, String subject5, String subject6,
			String subject7, String semester) {
		super();
	...
	public String toString() {
		return "Subject [subject1=" + subject1 + ", subject2=" + subject2 + ", subject3=" + subject3 + ", subject4="
				+ subject4 + ", subject5=" + subject5 + ", subject6=" + subject6 + ", subject7=" + subject7
				+ ", semester=" + semester + "]";
	}
